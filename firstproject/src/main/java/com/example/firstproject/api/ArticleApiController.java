...
public class ArticleApiController {
    ...
    public ResponseEntity<List<Article>> transactionTest(@RequestBody List<ArticleForm> articleDto) {
        List<Article> createdList = articleService.createArticles(articleDto);
